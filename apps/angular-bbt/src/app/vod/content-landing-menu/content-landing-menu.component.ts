...
export class ContentLandingMenuComponent implements OnDestroy, OnInit {
  @ViewChildren('playVideoButton, presentationButton, loginButton ,playImageButton,playStreamButton, playHtmlButton') buttons!: QueryList<ElementRef<HTMLAnchorElement>>;
